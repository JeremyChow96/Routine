...
namespace Routine.API.Controllers
{
    ...
    public class CompaniesController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetCompanies([FromQuery] CompanyDtoParameters parameters, [FromHeader(Name = "Accept")] string mediaType )
        {
            ...
            var shapedDate =  companyDtos.ShapeData(parameters.Fields);
            ...
            if (parsedMediaType?.MediaType == "application/vnd.company.hateoas+json")
            {
                ...
                var shapedCompaniesWithLinks = shapedDate.Select(c =>
                {
        ...
        private IEnumerable<LinkDto> CreateLinksForCompany(Guid companyId, string fields)
        {
            ...
            links.Add(new LinkDto(Url.Link(nameof(DeleteCompany),
                new { companyId }), "delete_company", "DELETE"));



            links.Add(new LinkDto(Url.Link(nameof(EmployeeController.CreateEmployeeForCompany),
                new { companyId}), "create_employee_for_company", "POST"));

            links.Add(new LinkDto(Url.Link(nameof(EmployeeController.GetEmployeesForCompany),
                new { companyId }), "employees", "GET"));
